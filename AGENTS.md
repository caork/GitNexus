...
This project is indexed by GitNexus as **GitNexus** (3463 symbols, 8373 relationships, 207 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
