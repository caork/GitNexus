...
const SHARED_PROPERTIES: SharedPropertyDef[] = [
  ...
  },
  {
    id: 'sp_isExported',
    apiName: 'isExported',
    displayName: 'Is Exported',
    baseType: 'Boolean',
    description: 'Whether the symbol is exported/public',
  },
  {
    id: 'sp_content',
    apiName: 'content',
  ...
  {
    id: 'sp_heuristicLabel',
    apiName: 'heuristicLabel',
    displayName: 'Label',
    baseType: 'String',
    description: 'Auto-detected or LLM-generated label',
  },
  {
    id: 'sp_confidence',
    apiName: 'confidence',
    ...
    baseType: 'Double',
    description: 'Resolution confidence score (0-1)',
  },
  {
    id: 'sp_reason',
    apiName: 'reason',
    displayName: 'Reason',
    baseType: 'String',
    description: 'Semantic reason for the relationship',
  },
];
...
const OBJECT_TYPES: ObjectTypeDef[] = [
  ...
  },
  {
    ...
    properties: [...CODE_ENTITY_PROPS, ...TYPE_DEF_PROPS],
    status: 'active',
    sourceLabels: ['TypeAlias', 'Typedef'],
  },
  {
    apiName: 'Record',
    displayName: 'Record',
  ...
  },
  {
    ...
    properties: CODE_ENTITY_PROPS,
    status: 'active',
    sourceLabels: ['Namespace', 'Module', 'Package'],
  },
  {
    apiName: 'Impl',
    displayName: 'Implementation Block',
...
const LINK_CONFIDENCE_PROP = prop(
  'confidence',
  'Confidence',
  'Double',
  false,
...
const LINK_TYPES: LinkTypeDef[] = [
  ...
  // ── Containment & Ownership ──
  {
    ...
    sourceType: 'FileSystemEntry',
    targetType: 'FileSystemEntry',
    cardinality: 'one-to-many',
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'CONTAINS',
  },
  {
    apiName: 'DEFINES',
    displayName: 'Defines',
    ...
    sourceType: 'File',
    targetType: 'CodeEntity',
    cardinality: 'one-to-many',
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'DEFINES',
  },
  {
    apiName: 'HAS_METHOD',
    ...
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'HAS_METHOD',
  },
  {
    apiName: 'HAS_PROPERTY',
  ...
  },
  {
    ...
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'ACCESSES',
  },
  {
    apiName: 'DECORATES',
    displayName: 'Decorates',
  ...
  // ── Architectural ──
  {
    ...
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'MEMBER_OF',
  },
  {
    apiName: 'STEP_IN_PROCESS',
    displayName: 'Step In Process',
    ...
    status: 'active',
    sourceRelType: 'STEP_IN_PROCESS',
  },
  {
    apiName: 'ENTRY_POINT_OF',
    displayName: 'Entry Point Of',
    description: 'Symbol is the entry point of a process/route/tool',
    sourceType: 'CodeEntity',
    targetType: 'ArchitecturalUnit',
    cardinality: 'many-to-one',
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'ENTRY_POINT_OF',
  },

  // ── Web / API ──
  {
    apiName: 'HANDLES_ROUTE',
    displayName: 'Handles Route',
    ...
    properties: STANDARD_LINK_PROPS,
    status: 'active',
    sourceRelType: 'HANDLES_ROUTE',
  },
  {
    apiName: 'HANDLES_TOOL',
    displayName: 'Handles Tool',
...
export const DEFAULT_ONTOLOGY: OntologySchema = {
  ...
  description:
    'Palantir-aligned ontology for source code knowledge graphs. Maps code entities, relationships, and architectural structures to typed Object Types with Interface polymorphism.',
