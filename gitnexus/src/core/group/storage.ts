...
/**
 * Returns the default GitNexus data directory. Delegates to the single
 * canonical implementation in `storage/repo-manager.ts` so that all
 * subsystems agree on the path (registry, repos, uploads, groups, etc.).
 */
